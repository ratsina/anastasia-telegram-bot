...
Интеграция работает отдельно от Telegram-бота. Она принимает события Instagram Direct и отвечает только на кодовое слово `ДВИЖЕНИЕ`.
...
3. В Direct должен появиться автоматический ответ со ссылкой-заглушкой.
